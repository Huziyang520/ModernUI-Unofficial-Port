...
public final class MuiFabricApi extends MuiModApi {
    ...
    public void loadEffect(GameRenderer gr, Identifier effect) {
        // MC 26.3: GameRenderer#setPostEffect was removed, so AccessGameRenderer's
        // @Invoker had no target left and Mixin failed during APPLY with
        // InvalidAccessorException. Disabled to match MuiForgeApi#loadEffect.
    }
