...
public class EmojiDataGen {
    ...
    public static void main(String[] args) {
        ...
        // MC 26.3: tinyfd was removed together with the GLFW dependency.
        iam_cal = FileDialogs.openFileDialog("Open IamCal", "JSON File", "json");
        joy_pixels = FileDialogs.openFileDialog("Open JoyPixels", "JSON File", "json");
        google_fonts = FileDialogs.openFileDialog("Open GoogleFonts", "JSON File", "json");
        output = FileDialogs.saveFileDialog("emoji_data.json", "JSON File", "json");
